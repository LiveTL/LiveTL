...
<ExpansionPanels bind:value>
  <ExpansionPanel>
    <span slot="header">Fixed auto-prefix bug</span>
    <div>
      All chat messages sent from LiveTL were auto-tagged with [en]. This
      critical bug has now been fixed.
    </div>
  </ExpansionPanel>
  <ExpansionPanel>
    ...
    <div>
      ...
      because a moderator bans a chat member). We hope this can cut down on spam
